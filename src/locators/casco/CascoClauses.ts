...
export const CascoClausesPageLocators = {
  ...
  strikesRiotsCivilDisturbancesRadioButton: (page: Page) =>
    page.locator("#radio_avarie7_yes"),
  workInstallationLabel: (page: Page) => page.locator("text=Work installation"),
  workInstallationRadioButton: (page: Page) =>
    page.locator("#radio_avarie2_yes"),
  damageCausedByTransportLabel: (page: Page) =>
    page.locator("text=Damage caused by transp."),
  damageCausedByTransportRadioButton: (page: Page) =>
    page.locator("#radio_avarie3_yes"),
  ...
  territorialExpansionLabel: (page: Page) =>
    page.locator("text=Territorial expansion"),
